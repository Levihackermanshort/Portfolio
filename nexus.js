...
document.addEventListener('DOMContentLoaded', () => {
    class NexusAI {
        constructor() {
            ...
            if (!this.widget) return; // Exit if widget element not found
            ...
            if (this.messages && this.input && this.sendButton && this.minimizeButton && 
                this.typingIndicator && this.moodDisplay && this.avatar && this.avatarPulse) {
